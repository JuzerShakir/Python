...
#time.time() gives total time taken to run the code till here and will substract the time taken to run till variable start. This gives us time taken to run the loop to add list

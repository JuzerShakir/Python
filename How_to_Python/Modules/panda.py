...
XYZ_web = {'Day' : [1, 2, 3, 4, 5, 6], 'Visiotrs' : [1000, 700, 6000, 1000, 400, 350], 'Bounce_rate' : [20, 20, 23, 15, 10, 34]}
...
ABC_web = pd.DataFrame({'Day' : [1, 2, 3, 4, 5, 6], 'Visiotrs' : [1000, 700, 6000, 1000, 400, 350], 'Bounce_rate' : [20, 20, 23, 15, 10, 34]})
DEF_web = pd.DataFrame({'Day' : [1, 2, 3, 4, 10, 6], 'Visiotrs' : [10000, 700, 6000, 1000, 400, 350], 'Bounce_rate' : [20, 20, 23, 15, 10, 33]})
...
print('\nJoining')
#defining 2 variables with a dataframes
ABC = pd.DataFrame({'Int_rate' : [1, 2, 3, 4, 5, 6], 'Int_GDP' : [1000, 700, 6000, 1000, 400, 350]}, index = [2001, 2002, 2003, 2004, 2005, 2006])
DEF= pd.DataFrame({'Low_tier_HPI' : [8, 10, 13, 14, 110, 16], 'Unemployment' : [10000, 7000, 60000, 10000, 4000, 3500]},  index = [2001, 2002, 2003, 2004, 2005, 2006])
